...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
    ...
    if (!empty($tope))
    {
        ...
        /** Consulta para obtener productos VIGENTES con unidades menores o iguales al tope especificado */
        // Se modifica la consulta para incluir la condición eliminado = 0
    ...
    <head>
        ...
        <title>Productos Vigentes por Unidades</title>
        <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
    </head>
    <body>
        <div class="container">
            <h3><br>PRODUCTOS VIGENTES CON UNIDADES MENORES O IGUALES A: <?= isset($tope) ? $tope : 'N/A' ?></h3>
            ...
            <?php if( !empty($rows) ) : ?>
                ...
                <div class="alert alert-info" role="alert">
                    Total de productos VIGENTES encontrados: <?= count($rows) ?>
                </div>
            ...
            <?php elseif(!empty($tope)) : ?>
                ...
                <div class="alert alert-warning" role="alert">
                    No se encontraron productos VIGENTES con un número de unidades menor o igual a <?= $tope ?>
                </div>
